...
urlpatterns = [
    ...
    path('fetch-multibaggers/view/', views.fetch_multibaggers_view, name='fetch_multibaggers_view'),

    path('fetch-multibaggers/', views.fetch_multibaggers, name='fetch_multibaggers'),
